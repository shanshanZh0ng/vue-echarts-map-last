...
export default {
  ...
  methods: {
     ...
     */
    mapChart(divid) {
      axios.get("http://172.16.18.215:8080/resources/static/json/map/" + chinaId + ".json", {}).then(response => {
                ...
                // if (cityId) {
                  if (name === "china"){
                    ...
                    if (params.name === "北京" || params.name === "上海" || params.name === "天津" || params.name === "重庆") {
                      ...
                      //代表有下级地图
                      axios
                        .get("http://172.16.18.215:8080/resources/static/json/map/" + cityId + ".json", {})
                        .then(response => {      
                          showTip(false);                                     
                          const mapJson = response.data;
